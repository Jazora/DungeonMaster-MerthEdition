...
obj
	...
	Troll
		...
		troll4x7
			icon = 'Troll.dmi'
			icon_state = "Normal 4x7"
			pixel_y = 32
		troll1x7
			icon = 'Troll.dmi'
			icon_state = "Normal 1x7"
			pixel_y = 64
		troll2x7
			icon = 'Troll.dmi'
			icon_state = "Normal 2x7"
			pixel_y = 32
			pixel_x = 32
		troll3x7
			icon = 'Troll.dmi'
			icon_state = "Normal 3x7"
			pixel_y = 32
			pixel_x = -32
		troll5x7
			icon = 'Troll.dmi'
			icon_state = "Normal 5x7"
			pixel_x = 32
		troll6x7
			icon = 'Troll.dmi'
			icon_state = "Normal 6x7"
			pixel_x = -32
obj
	Parts
		Nose
...
var/changes=list(
"RULES::Read Update File and Browser File for RULES AND UPDATES. ",\
"RULES:: Admins MAY NOT Use admin powers to kill units and/or damage units of players unless they have clearly broken rule #1. Failure to follow this rule will result in removal of admin powers",\
"Map made smaller to increase uptime and decrease lag, also to make roleplaying easier",\

"New Lore/Knowledge/Behavior expectations are in the UPDATES tab, THANK YOU, Please READ the UPDATES tab",\
"Vampires now have several new morphs",\
"Magic added, Ask an admin or read updates file to learn more, Do not request magic.",\
"Floors do not take resources to build, you still need the basic resource in your inventory to build them however",\
"Sun now does 25 damage to vampires instead of 50.",\
"Create Gremlins Admin Command Nerfed due to Lag and Crashing",\
"Icons for Hellforged Maces, Spears, and Axes are added, Items are not yet available and may never be available, Thank you.")
